...
export class Backend implements backendInterface {
    ...
    async bulkDelete(arg0: Array<bigint>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.bulkDelete(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteContent(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getAllHistory(): Promise<Array<ContentRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyHistory(): Promise<Array<ContentRecord>> {
        if (this.processError) {
            try {
    ...
    async saveContent(arg0: string, arg1: Array<string>, arg2: string, arg3: string, arg4: string, arg5: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveContent(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
